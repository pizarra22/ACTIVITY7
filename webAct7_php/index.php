...
if(isset($_GET['logout']) && $_GET['logout']== true){
  ...
  if($email == "pizarrajrromulo@gmail.com" && $password == "admin"){
        $_SESSION ['email'] = $email;
        $_SESSION ['password'] = $password;
        $message ="<div class='alert alert-success'>Login Successsfully</div>";
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <?php echo $message;?>
                                        <form action="" method ="get" onSubmit="return confirm('DO YOU REALY WANT TO CONTINUE?');">
